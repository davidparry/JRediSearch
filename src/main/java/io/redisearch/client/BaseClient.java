...
public abstract class BaseClient implements SearchClient, SuggestionClient, DocumentClient, IndexClient {

    abstract Connection _conn();

    protected BaseClient(String indexName, Commands.CommandProvider commands) {
    ...
    private static void handleListMapping(List<Object> items, BaseClient.KVHandler handler) {
